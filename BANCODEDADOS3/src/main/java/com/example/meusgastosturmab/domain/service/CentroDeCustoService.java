...
@Service
public class CentroDeCustoService implements 
    ICRUDService<CentroDeCustoRequestDTO, CentroDeCustoResponseDTO> {
    ...
    public CentroDeCustoResponseDTO obterPorId(Long id) {
        ...
        if(optCentroDeCusto.isEmpty()){
            throw new ResourceNotFoundException("Não foi possivel encontrar o centro de custo com o id: "
            + id);
        }
